...
<div class="panel panel-default">
    ...
    echo form_open_multipart(base_url('control/slider_servicios/add_imagen'), $atts);
...
if($query_imagenes->result()!=""){
    ...
    foreach ($query_imagenes->result() as $imagen) {
        ...
        <div class="container_img"><img src="'.base_url('images-slider_servicios/'.$imagen->filename).'" width="120" alt="" /></div>

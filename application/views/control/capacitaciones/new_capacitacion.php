...
$attributes = array('class' => 'form-horizontal', 'id' => 'new_capacitacion');
echo form_open_multipart(base_url('control/capacitaciones/create/'),$attributes);

echo form_hidden('capacitacion[id]');

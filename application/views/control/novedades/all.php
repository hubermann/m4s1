...
echo '<td>'.$row->slug.' </td>';
		...
		echo '<td> 
		<div class="btn-group">
		<a class="btn btn-small" onclick="confirm_delete('.$row->id.')" href="'.base_url('control/novedades/delete_comfirm/'.$row->id.'').'"><i class="fa fa-trash-o"></i></a>
		<a class="btn btn-small" href="'.base_url('control/novedades/editar/'.$row->id.'').'"><i class="fa fa-edit"></i></a><a class="btn btn-small" href="'.base_url('control/novedades/imagenes/'.$row->id.'').'"><i class="fa fa-camera-retro"></i></a>		

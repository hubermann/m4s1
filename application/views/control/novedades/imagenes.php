...
function confirma_eliminar(idvar, urldel) {
	...
	if (result==true) {
    	...
    	$.ajax({
    	    url: "/control/novedades/delete_imagen/"+idvar,
...
<div class="panel panel-default">
    ...
    echo form_open_multipart(base_url('control/novedades/add_imagen'), $atts);
...
if($query_imagenes->result()!=""){
    ...
    foreach ($query_imagenes->result() as $imagen) {
        ...
        <div class="container_img"><img src="'.base_url('images-novedades/'.$imagen->filename).'" width="120" alt="" /></div>
